...
```apt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/NT-GIT-HUB/BOT-FREE/main/iniciar.sh -O iniciar.sh; chmod +x iniciar.sh; ./iniciar.sh```
